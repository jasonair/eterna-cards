      ...
      <div className="max-w-[1400px] mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-stone-900 truncate">Import Inventory</h1>
          ...
          {step === 'upload' && (
            <button
              ...
              className="px-4 py-2 rounded-md border border-stone-200 text-stone-900 bg-white hover:bg-stone-100 text-xs sm:text-sm font-medium"
            >
              Download Template
            </button>
          )}
        ...
        {step === 'upload' && (
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg border border-stone-200 p-4">
              <h3 className="text-sm font-semibold text-stone-900 mb-2">Accepted formats</h3>
              <ul className="text-xs text-stone-500 space-y-1">
                <li>• <strong className="text-stone-600">CSV files</strong> — comma-separated values (.csv)</li>
                <li>• Column headers can use <strong className="text-stone-600">any names</strong> — our AI will auto-detect what each column means</li>
          ...
          <div className="space-y-4">
            {mappingLoading ? (
              ...
              <>
                ...
                {!hasNameMapping && (
                  <div className="bg-red-50 border border-yellow-600/50 rounded-md px-3 py-2 text-[11px] text-yellow-200">
                ...
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="px-4 py-2 rounded-md border border-stone-200 text-stone-600 bg-white hover:bg-stone-100 text-sm"
                  >
                    Back
                  </button>
                  <button
        ...
        {step === 'preview' && (
          <div className="space-y-4">
            <div className="bg-white rounded-lg border border-stone-200 p-4">
              <div className="flex items-center justify-between mb-3">
                <div>
                  <h3 className="text-sm font-semibold text-stone-900">Review Import</h3>
                  <p className="text-xs text-stone-500 mt-0.5">
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="border-b border-stone-200">
                      <th className="text-left py-2 px-2 text-stone-500 font-medium w-8">#</th>
                      <th className="text-left py-2 px-2 text-stone-500 font-medium">Name</th>
                      <th className="text-left py-2 px-2 text-stone-500 font-medium">SKU</th>
                      <th className="text-left py-2 px-2 text-stone-500 font-medium">Category</th>
                      <th className="text-left py-2 px-2 text-stone-500 font-medium">Supplier</th>
                      <th className="text-left py-2 px-2 text-stone-500 font-medium">Barcodes</th>
                      <th className="text-right py-2 px-2 text-stone-500 font-medium">On Hand</th>
                      <th className="text-right py-2 px-2 text-stone-500 font-medium">In Transit</th>
                      <th className="text-right py-2 px-2 text-stone-500 font-medium">Cost (GBP)</th>
                      <th className="text-right py-2 px-2 text-stone-500 font-medium">Total Value</th>
                      <th className="text-right py-2 px-2 text-stone-500 font-medium w-8"></th>
                    </tr>
                  </thead>
                  <tbody>
                    {previewRows.map((row, i) => (
                      <tr key={i} className="border-b border-stone-200 hover:bg-amber-50/30">
                        ...
                        <td className="py-1.5 px-2 text-right">
                          <span className={`${((row.quantityOnHand || 0) + (row.quantityInTransit || 0)) * (row.averageCostGBP || 0) > 0 ? 'text-stone-900' : 'text-stone-400'}`}>
            ...
            {/* Summary */}
            <div className="bg-white rounded-lg border border-stone-200 p-4">
              <h3 className="text-sm font-semibold text-stone-900 mb-2">Import Summary</h3>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
                <div>
                  <p className="text-stone-500">Total products</p>
                  <p className="text-lg font-semibold text-stone-900">{previewRows.length}</p>
                </div>
                <div>
                  <p className="text-stone-500">With stock</p>
                ...
                <div>
                  <p className="text-stone-500">Total value</p>
                  <p className="text-lg font-semibold text-stone-900">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs mt-4 max-w-md mx-auto">
                <div>
                  ...
                  <p className="text-xl font-semibold text-stone-900">{importResult.total}</p>
                </div>
                <div>
                  <p className="text-stone-500">Created</p>
                  <p className="text-xl font-semibold text-green-600">{importResult.created}</p>
                </div>
                <div>
              ...
              {importResult.errors && importResult.errors.length > 0 && (
                <div className="mt-4 text-left bg-white rounded-md p-3 max-w-lg mx-auto">
